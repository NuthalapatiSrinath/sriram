...
const MILESTONES = [
  {
    year: "2005",
    title: "The Beginning",
    description: "SRIRAM IAS Academy was founded with a vision to transform UPSC coaching in India. Started with just 30 students and 3 faculty members in a single classroom.",
    icon: Rocket,
  ...
  },
  {
    ...
    description: "Our first batch produced 12 UPSC selections including 3 in top 50 ranks. This proved our unique teaching methodology was effective.",
    icon: Trophy,
  ...
  },
  {
    ...
    description: "Expanded to 3 centers across India - Delhi, Chennai, and Bangalore. Introduced our comprehensive foundation course for the first time.",
    icon: Building2,
  ...
  },
  {
    ...
    description: "Launched online learning platform, making quality UPSC preparation accessible to students across India, even in remote areas.",
    icon: Monitor,
  ...
  },
  {
    ...
    description: "Crossed the landmark of 500+ total UPSC CSE selections. Became one of India's most trusted IAS coaching institutes.",
    icon: Crown,
  ...
  },
  {
    ...
    description: "Integrated AI-based personalized learning, adaptive test series, and smart analytics to revolutionize UPSC preparation.",
    icon: Brain,
  ...
  },
  {
    ...
    description: "Today we serve 50,000+ students with 6 centers, 100+ faculty, and the most comprehensive UPSC preparation ecosystem in India.",
    icon: Infinity,
...
const CORE_VALUES = [
  {
    ...
    description: "We uphold the highest standards of honesty and transparency in everything we do — from teaching to results.",
    color: "from-blue-500 to-indigo-600",
    bgColor: "bg-blue-50",
  ...
  },
  {
    icon: Target,
    title: "Excellence",
    description: "We strive for nothing less than the best in education, mentoring, and student outcomes every single day.",
    color: "from-emerald-500 to-teal-600",
  ...
  },
  {
    ...
    description: "Every decision, every course, every resource is designed keeping the student's success as the ultimate priority.",
  ...
  },
  {
    icon: Lightbulb,
    title: "Innovation",
    description: "We constantly evolve our teaching methods, embracing technology, and new pedagogical approaches.",
    color: "from-amber-500 to-orange-600",
    bgColor: "bg-amber-50",
  ...
  },
  {
    icon: Handshake,
    title: "Inclusivity",
    description: "Quality UPSC preparation should be accessible to all. We offer scholarships and flexible payment plans.",
  ...
  },
  {
    ...
    description: "We take responsibility for our students' journey, providing unwavering support from enrollment to selection.",
    color: "from-cyan-500 to-blue-600",
    bgColor: "bg-cyan-50",
...
const LEADERSHIP_TEAM = [
  {
    ...
    description: "With over 30 years of experience in civil services and education, Sri Ram Sir has personally mentored 200+ IAS/IPS officers. His vision of making quality education accessible drives the academy's mission.",
    avatar: "SR",
    gradient: "from-blue-600 to-indigo-700",
    specializations: ["General Studies", "Ethics & Governance", "Interview Preparation"],
    achievements: ["30+ Years in Civil Services Education", "Authored 12 bestselling UPSC books", "Government Education Advisor"],
  },
  {
    name: "Dr. Priya Krishnamurthy",
    role: "Academic Director",
    tagline: "Ph.D. Political Science, JNU | 18+ years in UPSC coaching",
    description: "Dr. Priya heads the academic department, designing curriculum, training faculty, and ensuring our courses remain the gold standard in UPSC preparation.",
    avatar: "PK",
    gradient: "from-purple-600 to-pink-700",
    specializations: ["Polity & Governance", "International Relations", "Mains Answer Writing"],
    achievements: ["Trained 50+ faculty members", "Developed proprietary answer-writing framework", "Published 8 academic papers"],
  },
  {
    name: "Vikram Rathore",
    role: "Director - Strategy & Operations",
    tagline: "IRS (Retd.), MBA ISB Hyderabad",
    description: "Vikram brings strategic vision and operational excellence. He oversees all centers, ensures quality consistency, and drives the technology integration roadmap.",
    avatar: "VR",
    gradient: "from-emerald-600 to-teal-700",
    specializations: ["Economy & Finance", "Test Series Strategy", "Student Analytics"],
    achievements: ["Launched AI-powered test analytics", "Expanded to 6 centers nationally", "Built partnership with 20+ universities"],
  },
];
...
const KEY_NUMBERS = [
  { value: "21+", label: "Years of Excellence", icon: Calendar, color: "text-blue-600", bg: "bg-blue-50" },
  { value: "500+", label: "UPSC Selections", icon: Trophy, color: "text-amber-600", bg: "bg-amber-50" },
  { value: "50K+", label: "Students Trained", icon: Users, color: "text-emerald-600", bg: "bg-emerald-50" },
  { value: "100+", label: "Expert Faculty", icon: GraduationCap, color: "text-purple-600", bg: "bg-purple-50" },
  { value: "6", label: "Pan India Centers", icon: MapPin, color: "text-rose-600", bg: "bg-rose-50" },
  { value: "95%", label: "Student Satisfaction", icon: Heart, color: "text-cyan-600", bg: "bg-cyan-50" },
];
...
const METHODOLOGY_STEPS = [
  {
    ...
    description: "We start by building a strong conceptual foundation through structured lectures, comprehensive notes, and NCERTs mastery. No shortcuts, only solid understanding.",
    icon: BookOpen,
    color: "from-blue-500 to-indigo-600",
    details: ["NCERT Foundation Program", "Concept Clarity Sessions", "Subject-wise Building Blocks", "Daily Reading Plans"],
  },
  {
    step: "02",
    title: "Strategic Answer Writing",
    description: "Master the art of writing crisp, structured, and scoring answers. Our proprietary SRIRAM Framework ensures you never miss key points in any answer.",
    icon: FileText,
    color: "from-emerald-500 to-teal-600",
    details: ["SRIRAM Answer Framework", "Daily Writing Practice", "Peer Review System", "Model Answer Analysis"],
  },
  {
    step: "03",
    title: "Test & Analyze",
    description: "Regular testing with AI-powered analytics helps identify strengths and weaknesses. Our adaptive test series evolves with your preparation level.",
    icon: BarChart3,
    color: "from-purple-500 to-pink-600",
    details: ["AI-Powered Analytics", "Adaptive Mock Tests", "Performance Tracking", "Weak Area Identification"],
  },
  {
    step: "04",
    title: "Current Affairs Integration",
    description: "Daily current affairs sessions seamlessly integrated with static syllabus. Our unique mapping technique connects news to UPSC questions.",
    icon: Globe,
    color: "from-amber-500 to-orange-600",
    details: ["Daily CA Sessions", "News-Syllabus Mapping", "Monthly Compilations", "Editorial Discussions"],
  },
  {
    step: "05",
    title: "Revision & Consolidation",
    description: "Structured revision through spaced repetition, revision tests, and mind-maps. Our 90-day revision plan ensures nothing is forgotten before the exam.",
    icon: Brain,
    color: "from-cyan-500 to-blue-600",
    details: ["Spaced Repetition System", "Quick Revision Notes", "Mind Map Library", "90-Day Rev Plan"],
  },
  {
    step: "06",
    title: "Interview Excellence",
    description: "Comprehensive personality test preparation with mock interviews conducted by retired civil servants and subject experts.",
    icon: Megaphone,
    color: "from-rose-500 to-red-600",
    details: ["Mock Interview Panels", "Body Language Training", "DAF Analysis", "Current Affairs Discussion"],
  },
];
...
const AboutSectionHeader = () => {
  ...
  return (
    ...
    >
      ...
      >
        For over two decades, we have been shaping the future of India by mentoring
        thousands of aspirants into becoming distinguished civil servants.
      </motion.p>
        ...
        <div className="relative flex flex-col lg:flex-row items-center gap-10 p-8 lg:p-14">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 p-8 text-center space-y-4">
                <motion.div
                  ...
                  animate={{ boxShadow: ["0 0 0 0 rgba(255,255,255,0.1)", "0 0 30px 10px rgba(255,255,255,0.1)", "0 0 0 0 rgba(255,255,255,0.1)"] }}
                  transition={{ duration: 3, repeat: Infinity }}
                >
                  SR
                </motion.div>
                <div>
                  <h4 className="text-xl font-black text-white">Sri Ram Sharma</h4>
                  <p className="text-blue-200 text-sm font-medium">Founder & Chief Mentor</p>
                  <p className="text-blue-300/70 text-xs mt-1">IAS (Retd.) | AIR 3 — UPSC CSE 1992</p>
                </div>
                <div className="pt-2">
                  <motion.div
                  ...
                  >
                    ...
                    <p className="text-sm text-blue-100 italic leading-relaxed px-4">
                      "Education is not just about clearing exams — it is about building the leaders
                      who will shape tomorrow's India. At SRIRAM IAS, we don't just teach, we transform."
                    </p>
                  </motion.div>
                </div>
                <div className="flex items-center justify-center gap-4 pt-3">
                  {[
                    ...
                    >
                      ...
                      <p className="text-[10px] text-blue-300/60 uppercase">{s.label}</p>
                    </motion.div>
                  ))}
                </div>
              </div>
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-bold text-amber-200">Our Story Since 2005</span>
            </motion.div>
            ...
            <div className="space-y-4 text-blue-100 leading-relaxed">
              <p>
                SRIRAM IAS Academy was born in 2005 from a simple yet powerful belief: every
                aspirant deserves access to world-class UPSC coaching, regardless of their
                background. What started as a small coaching center in Delhi with 30 passionate
                students has grown into one of India's most trusted IAS preparation institutes.
              </p>
              <p>
                Over the past 21 years, we have helped <span className="font-bold text-white">500+ students</span> achieve
                their dream of joining the Indian Civil Services. Our alumni serve as IAS, IPS, IFS,
                and IRS officers across the country, making a difference in governance and public service.
              </p>
              <p>
                Today, with <span className="font-bold text-white">6 centers</span>, <span className="font-bold text-white">100+ expert faculty</span>,
                and a cutting-edge online platform, we continue to evolve, innovate, and lead
                the way in UPSC preparation.
              </p>
            </div>
            ...
            >
              {["Est. 2005", "6 Centers", "100+ Faculty", "50K+ Students", "500+ Selections"].map((tag, i) => (
                <motion.span
                  key={tag}
    ...
    >
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {KEY_NUMBERS.map((item, index) => (
          ...
          >
            <div className={`relative p-5 rounded-2xl ${item.bg} border border-gray-100 shadow-lg shadow-blue-50/30 overflow-hidden text-center transition-all duration-300 group-hover:shadow-xl group-hover:border-blue-200`}>
              <motion.div
                className="absolute inset-0 bg-gradient-to-br from-blue-50/0 to-indigo-50/0 group-hover:from-blue-50 group-hover:to-indigo-50 transition-all duration-500"
              />
    ...
    >
      <motion.div variants={staggerItem} className="text-center mb-10">
        ...
        >
          ...
          <span className="text-sm font-bold text-indigo-700 uppercase tracking-wider">What We Stand For</span>
        </motion.div>
        <h3 className="text-3xl lg:text-4xl font-black text-gray-900 mb-3">
          Our Core <span className="text-blue-600">Values</span>
        </h3>
        <p className="text-gray-500 max-w-2xl mx-auto">
          These six pillars define who we are and guide every decision at SRIRAM IAS Academy.
        </p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {CORE_VALUES.map((val, index) => (
          <motion.div
            ...
            className="group"
          >
            <div className={`relative h-full p-7 rounded-2xl ${val.bgColor} border ${val.borderColor} shadow-lg overflow-hidden transition-all duration-300 group-hover:shadow-xl`}>
              <motion.div className={`absolute inset-0 bg-gradient-to-br ${val.color} opacity-0 group-hover:opacity-5 transition-opacity duration-500`} />
              <div className="relative z-10">
                <motion.div
                ...
                <h4 className="text-lg font-black text-gray-900 mb-2 group-hover:text-blue-700 transition-colors">{val.title}</h4>
    ...
    >
      <motion.div variants={staggerItem} className="text-center mb-12">
        ...
        >
          ...
          <span className="text-sm font-bold text-amber-700 uppercase tracking-wider">Our Journey</span>
        </motion.div>
        <h3 className="text-3xl lg:text-4xl font-black text-gray-900 mb-3">
          ...
          {MILESTONES.map((milestone, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`w-full lg:w-5/12 ${isLeft ? "lg:pr-12 lg:text-right" : "lg:pl-12 lg:text-left"}`}>
                  ...
                  >
                    <div className={`flex items-center gap-3 mb-3 ${isLeft ? "lg:justify-end" : ""}`}>
                      ...
                      <div>
                        <span className={`text-xs font-bold uppercase tracking-wider bg-gradient-to-r ${milestone.color} bg-clip-text text-transparent`}>
                          {milestone.year}
                        </span>
                ...
                >
                  <div className={`w-12 h-12 rounded-full bg-gradient-to-br ${milestone.color} flex items-center justify-center text-white text-xs font-black ring-4 ring-white shadow-xl`}>
    ...
    >
      <motion.div variants={staggerItem} className="text-center mb-12">
        ...
        >
          ...
          <span className="text-sm font-bold text-emerald-700 uppercase tracking-wider">Our Approach</span>
        </motion.div>
        <h3 className="text-3xl lg:text-4xl font-black text-gray-900 mb-3">
          The SRIRAM <span className="text-blue-600">Methodology</span>
        </h3>
        <p className="text-gray-500 max-w-2xl mx-auto">
          A proven 6-step framework that has consistently produced UPSC toppers for over two decades.
        </p>
      </motion.div>
        ...
        <div className="lg:col-span-4 space-y-3">
          {METHODOLOGY_STEPS.map((step, index) => (
            ...
            >
              ...
              >
                <step.icon className={`w-6 h-6 ${activeStep === index ? "text-white" : "text-white"}`} />
              </motion.div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <span className={`text-xs font-bold ${activeStep === index ? "text-blue-200" : "text-gray-400"}`}>
                    STEP {step.step}
                  </span>
                </div>
        ...
        <div className="lg:col-span-8">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative"
            >
              <div className={`relative rounded-3xl overflow-hidden bg-gradient-to-br ${METHODOLOGY_STEPS[activeStep].color} p-8 lg:p-10 text-white shadow-2xl`}>
                {/* Decorative */}
                <motion.div
                    ...
                    {METHODOLOGY_STEPS.map((_, i) => (
                      <motion.button
                        ...
                        className={`h-2 rounded-full transition-all duration-300 ${
                          i === activeStep ? "w-10 bg-white" : "w-2 bg-white/30 hover:bg-white/50"
                        }`}
    ...
    >
      <motion.div variants={staggerItem} className="text-center mb-12">
        ...
        >
          ...
          <span className="text-sm font-bold text-purple-700 uppercase tracking-wider">Leadership</span>
        </motion.div>
        <h3 className="text-3xl lg:text-4xl font-black text-gray-900 mb-3">
          Meet Our <span className="text-blue-600">Visionaries</span>
        </h3>
        <p className="text-gray-500 max-w-2xl mx-auto">
          The experienced leaders who drive our mission of transforming UPSC aspirants into civil servants.
        </p>
      </motion.div>
        ...
        {LEADERSHIP_TEAM.map((leader, index) => (
          ...
          >
            <div className="relative h-full rounded-3xl bg-white border border-gray-100 shadow-xl overflow-hidden transition-all duration-500 group-hover:shadow-2xl group-hover:border-blue-200">
              ...
              {/* Gradient Header */}
              <div className={`relative h-36 bg-gradient-to-r ${leader.gradient} overflow-hidden`}>
                <div className="absolute inset-0 opacity-10" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23ffffff' fill-opacity='0.4'%3E%3Ccircle cx='20' cy='20' r='1.5'/%3E%3C/g%3E%3C/svg%3E")` }} />
                <motion.div
              ...
              <div className="p-6 pt-4 text-center space-y-4">
                <div>
                  ...
                  <p className="text-sm font-bold text-blue-600">{leader.role}</p>
  ...
  const items = [
    {
      icon: Eye,
      title: "Our Vision",
      content: "To be India's most impactful IAS coaching institution — producing not just civil servants, but visionary leaders who transform governance and serve the nation with integrity, compassion, and innovation.",
      gradient: "from-blue-600 to-indigo-700",
      lightBg: "bg-blue-50",
    },
    {
      icon: Target,
      title: "Our Mission",
      content: "To democratize access to world-class UPSC preparation through innovative pedagogy, technology-driven learning, and unwavering commitment to every student's success, regardless of their socio-economic background.",
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {items.map((item, index) => (
          <motion.div
            ...
            className="group"
          >
            <div className={`relative h-full rounded-3xl overflow-hidden bg-gradient-to-br ${item.gradient} p-8 lg:p-10 text-white shadow-2xl transition-all duration-500 group-hover:shadow-3xl`}>
              {/* Background */}
              <div className="absolute inset-0 opacity-10">
              ...
              <div className="relative z-10 space-y-5">
                ...
                <h3 className="text-2xl lg:text-3xl font-black">{item.title}</h3>
  ...
  return (
    ...
    >
      <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-700 to-purple-700 p-10 lg:p-14 text-center shadow-2xl shadow-blue-500/20">
        ...
        <motion.div className="absolute top-6 left-6 w-20 h-20 rounded-full bg-white/5" animate={{ scale: [1, 1.3, 1] }} transition={{ duration: 8, repeat: Infinity }} />
        <motion.div className="absolute bottom-6 right-6 w-14 h-14 rounded-full bg-white/5" animate={{ y: [0, -15, 0] }} transition={{ duration: 5, repeat: Infinity }} />

        <div className="relative z-10 space-y-6">
          <motion.div className="inline-block" animate={{ rotate: 360 }} transition={{ duration: 12, repeat: Infinity, ease: "linear" }}>
          ...
          <h3 className="text-3xl lg:text-4xl font-black text-white">Ready to Begin Your IAS Journey?</h3>
          <p className="text-blue-100 text-lg max-w-2xl mx-auto">
            Join 50,000+ aspirants who chose SRIRAM IAS Academy as their trusted partner in UPSC preparation.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <motion.button className="flex items-center gap-2 px-10 py-4 rounded-xl bg-white text-blue-700 font-bold text-lg shadow-xl" whileHover={{ scale: 1.05, y: -3 }} whileTap={{ scale: 0.95 }}>
            ...
            <motion.button className="flex items-center gap-2 px-8 py-4 rounded-xl border-2 border-white/30 text-white font-bold text-lg hover:bg-white/10 transition-all" whileHover={{ scale: 1.05, y: -3 }} whileTap={{ scale: 0.95 }}>
